...
/*------------------------------------------- Another Implementation ITI LAB---------------------------------------------------*/
//#include "RCC_int.h"
//
...
//void MRCC_vEnableCLK(u8 A_u8BusID, u8 A_u8OrepheralID)
//{
//   switch(A_u8BusID)
//   {
//       case MRCC_AHB1: SET_BIT(RCC->AHB1ENR, A_u8OrepheralID); break;
//       case MRCC_APB1: SET_BIT(RCC->APB1ENR, A_u8OrepheralID); break;
//       case MRCC_APB2: SET_BIT(RCC->APB2ENR, A_u8OrepheralID); break;
//   }
//}
//
...
//   switch(A_u8BusID)
//   {
//       case MRCC_AHB1: ClR_BIT(RCC->AHB1ENR, A_u8OrepheralID); break;
//       case MRCC_APB1: ClR_BIT(RCC->APB1ENR, A_u8OrepheralID); break;
//       case MRCC_APB2: ClR_BIT(RCC->APB2ENR, A_u8OrepheralID); break;
//   }
//}
/*------------------------------------------- Another Implementation ITI LAB---------------------------------------------------*/
}
